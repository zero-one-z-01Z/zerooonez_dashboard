<aside id="layout-menu" class="layout-menu menu-vertical menu">
 ...
 @endphp
    ...
    <ul class="menu-inner py-1">
        ...
        @if(admin()->check())
                @if(\Illuminate\Support\Facades\Gate::any(['view_user','view_admin']) || app(\App\Dashboard\Services\Dashboard\ResourceRegistry::class)->hasVisibleGroup('users'))
                    <li class="menu-item {{ app(\App\Dashboard\Services\Dashboard\ResourceRegistry::class)->groupActive('users') ? 'active open' : '' }} {{Route::is(['admin.users.index','admin.users.show','admin.admins.index'])? 'active' : ''}}">
                        <a href="javascript:void(0);" class="menu-link menu-toggle">
                            <i class="menu-icon icon-base ti tabler-user"></i>
                            <div>{{__('admin.users')}}</div>
                        </a>
                        <ul class="menu-sub">
                            @include('dashboard.admin-components.generated-links', ['generatedGroup' => 'users'])
                            @can('view_user')
                ...
                @endif
                @if(\Illuminate\Support\Facades\Gate::any(['view_scanner','view_company','view_feature','view_car_option','view_transportation','view_time','view_part']) || app(\App\Dashboard\Services\Dashboard\ResourceRegistry::class)->hasVisibleGroup('scan'))
                    <li class="menu-item {{ app(\App\Dashboard\Services\Dashboard\ResourceRegistry::class)->groupActive('scan') ? 'active open' : '' }} {{Route::is(['admin.scanners.index',
...
'admin.times.index','admin.area_times.index','admin.parts.index'])? 'active' : ''}}">
                        ...
                        <ul class="menu-sub">
                            @include('dashboard.admin-components.generated-links', ['generatedGroup' => 'scan'])
                            ...
                            @endcan
                                ...
                                @endcan
                                @if(\Illuminate\Support\Facades\Gate::any(['view_time']) || app(\App\Dashboard\Services\Dashboard\ResourceRegistry::class)->hasVisibleGroup('scan_times'))
                                    <li class="menu-item {{ app(\App\Dashboard\Services\Dashboard\ResourceRegistry::class)->groupActive('scan_times') ? 'active open' : '' }} {{Route::is(['admin.times.index','admin.area_times.index'])? 'active' : ''}}">
                                        <a href="javascript:void(0);" class="menu-link menu-toggle">
                                            <i class="menu-icon icon-base ti tabler-clock-hour-2"></i>
                                            <div>{{__('admin.scan_times')}}</div>
                                        </a>
                                        <ul class="menu-sub">
                            @include('dashboard.admin-components.generated-links', ['generatedGroup' => 'scan_times'])
                            @can('view_time')
                ...
                @endif
                @if(\Illuminate\Support\Facades\Gate::any(['view_customer_service','view_customer_service_fees','view_customer_service_employee','view_customer_service_employee_fee','view_optional_phone']) || app(\App\Dashboard\Services\Dashboard\ResourceRegistry::class)->hasVisibleGroup('customer_service'))
                    <li class="menu-item {{ app(\App\Dashboard\Services\Dashboard\ResourceRegistry::class)->groupActive('customer_service') ? 'active open' : '' }} {{Route::is(['admin.customer_services.index','admin.customer_service_fees.index',
                        ...
                        <ul class="menu-sub">
                            @include('dashboard.admin-components.generated-links', ['generatedGroup' => 'customer_service'])
                ...
                @endif
                    @if(\Illuminate\Support\Facades\Gate::any(['view_city','view_area']) || app(\App\Dashboard\Services\Dashboard\ResourceRegistry::class)->hasVisibleGroup('zones'))
                        <li class="menu-item {{ app(\App\Dashboard\Services\Dashboard\ResourceRegistry::class)->groupActive('zones') ? 'active open' : '' }} {{Route::is(['admin.cities.index','admin.areas.index'])? 'active' : ''}}">
                            <a href="javascript:void(0);" class="menu-link menu-toggle">
                                <i class="menu-icon icon-base ti tabler-building-community"></i>
                                <div>{{__('admin.zones')}}</div>
                            </a>
                            <ul class="menu-sub">
                            @include('dashboard.admin-components.generated-links', ['generatedGroup' => 'zones'])
                                @can('view_city')
                    ...
                    @endif
                @if(\Illuminate\Support\Facades\Gate::any(['view_brand','view_brand_model']) || app(\App\Dashboard\Services\Dashboard\ResourceRegistry::class)->hasVisibleGroup('cars'))
                    <li class="menu-item {{ app(\App\Dashboard\Services\Dashboard\ResourceRegistry::class)->groupActive('cars') ? 'active open' : '' }} {{Route::is(['admin.brands.index','admin.brand_models.index','admin.brand_model_classes.index'])? 'active' : ''}}">
                        <a href="javascript:void(0);" class="menu-link menu-toggle">
                            <i class="menu-icon icon-base ti tabler-car"></i>
                            <div>{{__('admin.cars')}}</div>
                        </a>
                        <ul class="menu-sub">
                            @include('dashboard.admin-components.generated-links', ['generatedGroup' => 'cars'])
                            @can('view_brand')
                ...
                @endif
                @if(\Illuminate\Support\Facades\Gate::any(['view_faq']) || app(\App\Dashboard\Services\Dashboard\ResourceRegistry::class)->hasVisibleGroup('faqs'))
                    <li class="menu-item {{ app(\App\Dashboard\Services\Dashboard\ResourceRegistry::class)->groupActive('faqs') ? 'active open' : '' }} {{Route::is(['admin.faq_categories.index','admin.faq.index'])? 'active' : ''}}">
                        <a href="javascript:void(0);" class="menu-link menu-toggle">
                            <i class="menu-icon icon-base ti tabler-help-octagon"></i>
                            <div>{{__('admin.faqs')}}</div>
                        </a>
                        <ul class="menu-sub">
                            @include('dashboard.admin-components.generated-links', ['generatedGroup' => 'faqs'])
                            @can('view_faq')
...
{{--                    </li>--}}
{{--                @endcan--}}
                @if(\Illuminate\Support\Facades\Gate::any(['view_coupon']) || app(\App\Dashboard\Services\Dashboard\ResourceRegistry::class)->hasVisibleGroup('coupons'))
                    <li class="menu-item {{ app(\App\Dashboard\Services\Dashboard\ResourceRegistry::class)->groupActive('coupons') ? 'active open' : '' }} {{Route::is(['admin.coupons.index','admin.seller_coupons.index']) ? 'active' : ''}}">
                        <a href="javascript:void(0);" class="menu-link menu-toggle">
                            <i class="menu-icon icon-base ti tabler-discount"></i>
                            <div>{{__('admin.coupons')}}</div>
                        </a>
                        <ul class="menu-sub">
                            @include('dashboard.admin-components.generated-links', ['generatedGroup' => 'coupons'])
                            @can('view_coupon')
...
{{--                @endcan--}}
            ...
            @endcan
            @if(\Illuminate\Support\Facades\Gate::any(['view_ticket','view_ticket_category']) || app(\App\Dashboard\Services\Dashboard\ResourceRegistry::class)->hasVisibleGroup('tickets'))
                <li class="menu-item {{ app(\App\Dashboard\Services\Dashboard\ResourceRegistry::class)->groupActive('tickets') ? 'active open' : '' }} {{Route::is(['admin.tickets.index','admin.ticket_categories.index'])? 'active' : ''}}">
                    <a href="javascript:void(0);" class="menu-link menu-toggle">
                        <i class="menu-icon icon-base ti tabler-ticket"></i>
                        <div>{{__('admin.tickets')}}</div>
                    </a>
                    <ul class="menu-sub">
                            @include('dashboard.admin-components.generated-links', ['generatedGroup' => 'tickets'])
        ...
        @include('dashboard.admin-components.generated-navigation')
    </ul>
</aside>
