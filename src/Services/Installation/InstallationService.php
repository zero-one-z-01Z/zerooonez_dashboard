...
namespace ZeroOneZ\Dashboard\Services\Installation;
...
final class InstallationService
{
    ...
    private function registerProvider(array &$undo): bool
    {
        ...
        if (! preg_match('/return\s*\[/', $contents) || ! preg_match('/\];\s*$/', $contents)) throw new RuntimeException('Cannot safely register DashboardServiceProvider in bootstrap/providers.php.');
