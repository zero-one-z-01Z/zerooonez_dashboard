...
use App\Dashboard\Http\Controllers\GeneratedResourceControllerV2;
use App\Dashboard\Http\Controllers\GeneratedResourceController;

if (! function_exists('admin')) {
    function admin(): \Illuminate\Contracts\Auth\StatefulGuard { return auth()->guard('admin'); }
}

if (! function_exists('admin_user')) {
    function admin_user(): ?\App\Models\Admin { $user = admin()->user(); return $user instanceof \App\Models\Admin ? $user : null; }
}

if (! function_exists('customer_service_employee')) {
    function customer_service_employee(): \Illuminate\Contracts\Auth\StatefulGuard { return auth()->guard('web'); }
}

if (! function_exists('company')) {
    function company(): \Illuminate\Contracts\Auth\StatefulGuard { return auth()->guard('web'); }
}

if (! function_exists('customer_service')) {
    function customer_service(): \Illuminate\Contracts\Auth\StatefulGuard { return auth()->guard('web'); }
}

if (! function_exists('show_password_modal')) {
    function show_password_modal(): bool { return false; }
}

if (! function_exists('get_change_language_link')) {
    function get_change_language_link(): string { return route('admin.change_lang', ['lang' => '__lang__']); }
}

if (! function_exists('get_update_password_link')) {
    function get_update_password_link(): string { return route('admin.update_password'); }
}
