                        ...
                        return function () {
                            ...
                            n && n.requirejs || (n ? t = n : n = {}, function (n) {
                                ...
                                s = function (e, t) {
                                    ...
                                    if (m = b(r = r || e), "undefined" === x || "function" === x) {
                                        for (t = !t.length && i.length ? ["require", "exports", "module"] : t, f = 0; f < t.length; f += 1) if ("require" === (u = (h = s(t[f], m)).f)) $[f] = a.require(e); else if ("exports" === u) $[f] = a.exports(e), y = !0; else if ("module" === u) o = $[f] = a.module(e); else if (g(l, u) || g(c, u) || g(d, u)) $[f] = w(u); else {
                            ...
                            return n.prototype.bind = function (e, t, n) {
                                ...
                                var a = {height: this.$dropdown.outerHeight(!1)},
                                    ...
                                    c = l.top < o.top - a.height, u = l.bottom > o.bottom + a.height,
                                    d = {left: o.left, top: s.bottom}, p = this.$dropdownParent;
