...
<div class="layout-wrapper layout-content-navbar  ">
    <div class="layout-container">
        @include('dashboard.layout.parts.admin-sidebar')
        <div class="layout-page">
    @include('dashboard.layout.parts.admin-header')
            @yield('content')
        </div>
...
@include('dashboard.admin-components.update-password')


@include('dashboard.layout.parts.dashboard-runtime-config')
@stack('scripts')
{{--<script>--}}
