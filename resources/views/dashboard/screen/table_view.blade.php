...
@section('content')
    <div class="content-wrapper">
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            <div class="row g-6">
                @include('zerooonez-dashboard::admin-components.table-statistics')
                <!-- Product List Table -->
                <div class="card">
                    @component('zerooonez-dashboard::admin-components.table-card', [
                ...
                'filter_display' => $data['filter_display'],
                        ...
                        @if(!empty($data['filters']))
                            @slot('filter')
                                @include('zerooonez-dashboard::admin-components.table-filters.filters', [
...
--}}
@include('zerooonez-dashboard::admin-components.all-modals',$data)
