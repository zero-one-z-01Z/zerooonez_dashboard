!function (e, t) {
    ...
    return function () {
        ...
        var l = ["transitionend", "webkitTransitionEnd", "oTransitionEnd"], a = function () {
            ...
            return t = e, n = [{
                ...
                key: "_toggleDropdown", value: function (t, n, i) {
                    ...
                    if (t) {
                        ...
                        if (h.length && h[0].removeAttribute("data-hover", "true"), n.classList.remove("open"), o.style[this._rtl ? "marginRight" : "marginLeft"] = null, i) for (var m = o.querySelectorAll(".menu-item.open"), _ = 0, v = m.length; _ < v; _++) m[_].classList.remove("open")
                    }
                }
            }, {
                ...
                key: "switchMenu", value: function (t) {
                    this._unbindEvents();
                    var n = document.querySelector("nav.layout-navbar"), o = document.querySelector("#navbar-collapse"),
                        r = document.querySelector("#layout-menu div"), s = document.querySelector("#layout-menu"),
                        l = document.querySelector(".menu-horizontal-wrapper"),
                        a = document.querySelector(".menu-inner"), u = document.querySelector(".app-brand"),
                        c = document.querySelector(".layout-menu-toggle"),
                        d = document.querySelectorAll(".menu-inner .active"), h = window.PerfectScrollbar;
                    if ("vertical" === t) {
                        var m, _;
            ...
            }], n && r(t.prototype, n), o && r(t, o), Object.defineProperty(t, "prototype", {writable: !1}), t;
            var t, n, o
        }();
